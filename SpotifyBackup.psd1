#
# Manifiesto del módulo 'PSGet_SpotifyBackup'
#
# Generado por SpotifyBackup Module by Amaro Castro
#
# Generado el 07/08/2024
#

@{

# Módulo de script o archivo de módulo binario asociado con este manifiesto.
RootModule = 'SpotifyBackup.psm1'
